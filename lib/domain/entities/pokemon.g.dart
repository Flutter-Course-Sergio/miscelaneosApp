...
int _pokemonEstimateSize(
  ...
  bytesCount += 3 + object.frontSprite.length * 3;
...
void _pokemonSerialize(
  ...
  writer.writeString(offsets[0], object.frontSprite);
...
Pokemon _pokemonDeserialize(
  ...
  final object = Pokemon(
    frontSprite: reader.readString(offsets[0]),
...
extension PokemonQueryFilter
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> frontSpriteEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'frontSprite',
        value: value,
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> frontSpriteGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> frontSpriteLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> frontSpriteBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> frontSpriteStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> frontSpriteEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> frontSpriteContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> frontSpriteMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> frontSpriteIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'frontSprite',
        value: '',
...
extension PokemonQuerySortBy on QueryBuilder<Pokemon, Pokemon, QSortBy> {
  QueryBuilder<Pokemon, Pokemon, QAfterSortBy> sortByFrontSprite() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'frontSprite', Sort.asc);
    });
  }

  QueryBuilder<Pokemon, Pokemon, QAfterSortBy> sortByFrontSpriteDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'frontSprite', Sort.desc);
    });
  }
...
extension PokemonQuerySortThenBy
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterSortBy> thenByFrontSprite() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'frontSprite', Sort.asc);
    });
  }

  QueryBuilder<Pokemon, Pokemon, QAfterSortBy> thenByFrontSpriteDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'frontSprite', Sort.desc);
    });
  }
...
extension PokemonQueryWhereDistinct
  ...
  QueryBuilder<Pokemon, Pokemon, QDistinct> distinctByFrontSprite(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'frontSprite', caseSensitive: caseSensitive);
    });
  }
...
extension PokemonQueryProperty
  ...
  QueryBuilder<Pokemon, String, QQueryOperations> frontSpriteProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'frontSprite');
    });
  }
